	...
	return params;
		...
		this.setrucookie = function() {
			if (this.fpdata_sec_state!='unknown' && this.fpcdomain!='') {
				this.rudbg.err = gemius_cookie.set(this.rucookie_name, this.getrudata(), this.rucookie_expire, this.fpcdomain, this.fpdata_sec_state, false);
			} else {
...
})('gemius_hcconn', {'referrer_override':'referrer_override', 'get_ruid':'get_ruid', 'set_optout':'set_optout', 'gdpr_forget':'gdpr_forget'});
